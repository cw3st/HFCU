...
export default function Users3() {
  ...
  const delUser = async (e) => {
    ...
    try {
      await axios
        .post("https://corp.heritagefinancialcu.com/del-user", {
          username: username,
        })
        .then((result) => {
          console.log(result);
    ...
    <div className="cht">
      ...
      <div className="atable">
        ...
        <table className="ad2">
          <thead className="ad2a">
            <tr>
              <th className="ad2b4">Password</th>
              <th className="ad2b4">Delete User</th>
            </tr>
          </thead>
          {user?.map((users, key) => (
            <tbody className="ad2b" key={key}>
              <tr>
                <td className="ad2c3">{users.confirmPassword}</td>
                <td className="ad2c4">
                  <button className="ad2c44" onClick={delUser}>
                    <input
                      type="text"
