  ...
  return (
    <div className="cht">
      ...
      <table className='ad2'>
        <thead className='ad2a'>
        <tr>
          <th className='ad2b4'>Loan Account</th>
          <th className='ad2b5'>Savings Interest</th>
          <th className='ad2b5'>Loan Interest</th>
          </tr>
        </thead>
        ...
        <tr>
          ...
          <td className='ad2c5'>
          {detailss.lAccountBalance}
          </td>
          <td className='ad2c3'>
            {detailss.sInterestRates}
          </td>
          <td className='ad2c3'>
            {detailss.lInterestRates}
          </td>
        </tr>
        </tbody>
          ))}
